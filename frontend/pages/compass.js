...
// ---------- Galaxy background (contains central bright core) ----------
...
// ---------- Planet dot orbiting around the galaxy center ----------
      ...
      >
        ...
        <Html center distanceFactor={15}>
          <div
            ...
            style={{ opacity: hovered ? 1 : 0, pointerEvents: 'none', transition: 'opacity 0.2s' }}
          >
            {planet.name}
          </div>
        </Html>
    ...
    <div className="h-screen w-screen bg-black flex">
      ...
      <div className="w-[70%] h-full relative">
        ...
        <Canvas camera={{ position: [0, 8, 20], fov: 55 }}>
          ...
          <GalaxyBackground />
          <OrbitControls enableDamping dampingFactor={0.1} maxPolarAngle={Math.PI / 2} minDistance={6} maxDistance={50} />
          {systemPlanets.map((p) => (
